...
# ------------------------------------------------------------------
$(GENERATED_DIR)/ccf_validation_skin.owl: | $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call download_ccf_validation_owl,Skin)
.PRECIOUS: $(GENERATED_DIR)/ccf_validation_skin.owl
...
$(EXTRACTS_DIR)/uberon_skin.owl: $(EXTRACTS_DIR) \
		...
		$(GENERATED_DIR)/ccf_validation_skin.owl \
