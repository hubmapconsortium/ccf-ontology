...
# ------------------------------------------------------------------
$(GENERATED_DIR)/ccf_validation_fallopian_tube.owl: | $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call download_ccf_validation_owl,Fallopian_tube)
.PRECIOUS: $(GENERATED_DIR)/ccf_validation_fallopian_tube.owl
...
$(EXTRACTS_DIR)/uberon_fallopian_tube.owl: $(EXTRACTS_DIR) \
		...
		$(GENERATED_DIR)/ccf_validation_fallopian_tube.owl \
