...
# ------------------------------------------------------------------
$(GENERATED_DIR)/ccf_validation_heart.owl: | $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call download_ccf_validation_owl,Heart)
.PRECIOUS: $(GENERATED_DIR)/ccf_validation_heart.owl
...
$(GENERATED_DIR)/ccf_cell_biomarkers_heart.owl: check_asctb2ccf $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call generate_ccf_cell_biomarkers_component,Heart,https://docs.google.com/spreadsheets/d/1eSzDzv_wOpMGTrSShmy_S7IXs8_H_Kp3QZg-gfKyUWk/edit#gid=1759721736)
...
$(GENERATED_DIR)/ccf_asctb_annotations_heart.owl: check_asctb2ccf $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call generate_ccf_asctb_annotations_component,Heart,https://docs.google.com/spreadsheets/d/1eSzDzv_wOpMGTrSShmy_S7IXs8_H_Kp3QZg-gfKyUWk/edit#gid=1759721736)
...
$(EXTRACTS_DIR)/uberon_heart.owl: $(EXTRACTS_DIR) \
		...
		$(GENERATED_DIR)/ccf_validation_heart.owl \
