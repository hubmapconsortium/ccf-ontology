...
$(GENERATED_DIR)/ccf_cell_biomarkers_muscular_system.owl: check_asctb2ccf $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call generate_ccf_cell_biomarkers_component,MuscularSystem,https://docs.google.com/spreadsheets/d/1thptktZjTNd2ssJqIbChd01dPdCU1iaO0JmRkU2x80E/edit#gid=0)
...
$(GENERATED_DIR)/ccf_asctb_annotations_muscular_system.owl: check_asctb2ccf $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call generate_ccf_asctb_annotations_component,MuscularSystem,https://docs.google.com/spreadsheets/d/1thptktZjTNd2ssJqIbChd01dPdCU1iaO0JmRkU2x80E/edit#gid=0)
