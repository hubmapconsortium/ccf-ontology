...
# ------------------------------------------------------------------
$(GENERATED_DIR)/ccf_partonomy_fallopian_tube.owl: | $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call download_ccf_partonomy_component,Fallopian_tube)
.PRECIOUS: $(GENERATED_DIR)/ccf_partonomy_fallopian_tube.owl
...
$(GENERATED_DIR)/ccf_cell_biomarkers_fallopian_tube.owl: check_asctb2ccf $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call generate_ccf_cell_biomarkers_component,https://docs.google.com/spreadsheets/d/16tAvAmjwKwbq5SDz7UZ-T1N_KUHRGqPDbMqffFuInMI/edit#gid=1739942440)
...
$(GENERATED_DIR)/ccf_asctb_annotations_fallopian_tube.owl: check_asctb2ccf $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call generate_ccf_asctb_annotations_component,https://docs.google.com/spreadsheets/d/16tAvAmjwKwbq5SDz7UZ-T1N_KUHRGqPDbMqffFuInMI/edit#gid=1739942440)
...
$(EXTRACTS_DIR)/uberon_fallopian_tube.owl: $(EXTRACTS_DIR) \
		...
		$(GENERATED_DIR)/ccf_partonomy_fallopian_tube.owl \
