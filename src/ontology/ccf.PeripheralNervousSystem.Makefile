...
# ------------------------------------------------------------------
$(GENERATED_DIR)/ccf_validation_peripheral_nervous_system.owl: | $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call download_ccf_validation_owl,Peripheral_nervous_system)
.PRECIOUS: $(GENERATED_DIR)/ccf_validation_peripheral_nervous_system.owl

$(GENERATED_DIR)/ccf_validation_extended_peripheral_nervous_system.owl: | $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call download_ccf_validation_extended_owl,Peripheral_nervous_system)
.PRECIOUS: $(GENERATED_DIR)/ccf_validation_extended_peripheral_nervous_system.owl
...
$(EXTRACTS_DIR)/uberon_peripheral_nervous_system.owl: $(EXTRACTS_DIR) \
		...
		$(GENERATED_DIR)/ccf_validation_peripheral_nervous_system.owl \
		$(GENERATED_DIR)/ccf_validation_extended_peripheral_nervous_system.owl \
...
# ------------------------------------------------------------------
$(EXTRACTS_DIR)/lmha_peripheral_nervous_system.owl: $(EXTRACTS_DIR) \
		$(GENERATED_DIR)/ccf_asctb_annotations_peripheral_nervous_system.owl \
		$(GENERATED_DIR)/ccf_cell_biomarkers_peripheral_nervous_system.owl \
		$(GENERATED_DIR)/ccf_validation_peripheral_nervous_system.owl \
		$(GENERATED_DIR)/ccf_validation_extended_peripheral_nervous_system.owl \
...
.PRECIOUS: $(EXTRACTS_DIR)/lmha_peripheral_nervous_system.owl
...
$(COMPONENTSDIR)/asctb_peripheral_nervous_system.owl: $(COMPONENTSDIR) \
		...
		$(EXTRACTS_DIR)/lmha_peripheral_nervous_system.owl \
