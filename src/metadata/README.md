 ...
 * [ccf.yml](ccf.yml)
     * Determines how your purl.obolibrary.org/obo/ccf/ redirects will be handled
     ...
     * Paste in the contents of [ccf.yml](ccf.yml)
 ...
 * [ccf.md](ccf.md)
     ...
     * Paste in the contents of [ccf.md](ccf.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
