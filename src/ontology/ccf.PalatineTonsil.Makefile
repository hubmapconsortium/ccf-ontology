...
# ------------------------------------------------------------------
$(GENERATED_DIR)/ccf_validation_palatine_tonsil.owl: | $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call download_ccf_validation_owl,Palatine_Tonsil)
.PRECIOUS: $(GENERATED_DIR)/ccf_validation_palatine_tonsil.owl
...
$(GENERATED_DIR)/ccf_cell_biomarkers_palatine_tonsil.owl: check_asctb2ccf $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call generate_ccf_cell_biomarkers_component,PalatineTonsil,)
...
$(GENERATED_DIR)/ccf_asctb_annotations_palatine_tonsil.owl: check_asctb2ccf $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call generate_ccf_asctb_annotations_component,PalatineTonsil,)
...
$(EXTRACTS_DIR)/uberon_palatine_tonsil.owl: $(EXTRACTS_DIR) \
		...
		$(GENERATED_DIR)/ccf_validation_palatine_tonsil.owl \
