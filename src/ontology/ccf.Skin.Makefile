...
# ------------------------------------------------------------------
$(GENERATED_DIR)/ccf_partonomy_skin.owl: | $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call download_ccf_partonomy_component,Skin)
.PRECIOUS: $(GENERATED_DIR)/ccf_partonomy_skin.owl
...
$(GENERATED_DIR)/ccf_cell_biomarkers_skin.owl: check_asctb2ccf $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call generate_ccf_cell_biomarkers_component,https://docs.google.com/spreadsheets/d/1Pmi3g26vhbg9HU6GDpIvxKbIP985JM-5eytOHxJUdZs/edit#gid=269383687)
...
$(GENERATED_DIR)/ccf_asctb_annotations_skin.owl: check_asctb2ccf $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call generate_ccf_asctb_annotations_component,https://docs.google.com/spreadsheets/d/1Pmi3g26vhbg9HU6GDpIvxKbIP985JM-5eytOHxJUdZs/edit#gid=269383687)
...
$(EXTRACTS_DIR)/uberon_skin.owl: $(EXTRACTS_DIR) \
		...
		$(GENERATED_DIR)/ccf_partonomy_skin.owl \
