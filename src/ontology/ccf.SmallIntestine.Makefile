...
# ------------------------------------------------------------------
$(GENERATED_DIR)/ccf_partonomy_small_intestine.owl: | $(GENERATED_DIR)
	$(info [$(shell date +%Y-%m-%d\ %H:%M:%S)] make: Generating $@)
	$(call download_ccf_partonomy_component,Small_intestine)
.PRECIOUS: $(GENERATED_DIR)/ccf_partonomy_small_intestine.owl
...
$(EXTRACTS_DIR)/uberon_small_intestine.owl: $(EXTRACTS_DIR) \
		...
		$(GENERATED_DIR)/ccf_partonomy_small_intestine.owl \
